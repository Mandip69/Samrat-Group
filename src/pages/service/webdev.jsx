...
const WebDevelopment = () => {
  const googleFormLink =
    "https://docs.google.com/forms/d/e/1FAIpQLSesH80HyFX_2xClKTIvCCFyIsKsN0zioJE1FZV5kthWjtkzlg/viewform?usp=sharing&ouid=100782127818539968867";
    ...
    <div className="w-full bg-gray-50 text-gray-800 font-sans">
      ...
      <div className="relative w-full h-96 flex items-center justify-center text-white">
        <img
          src="/dev.png"
          alt="Web Development"
          className="absolute inset-0 w-full h-full object-cover brightness-75 rounded-b-2xl"
        />
        <div className="relative text-center px-4">
          ...
          <p className="text-lg md:text-xl">
            Static, Dynamic, E-commerce & Custom Solutions
          </p>
          <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white rounded-2xl shadow-lg p-6 flex flex-col items-center text-center hover:scale-105 transition">
            ...
            <p className="text-gray-600">
              Websites tailored to your business needs, static or dynamic.
            </p>
          </div>
          <div className="bg-white rounded-2xl shadow-lg p-6 flex flex-col items-center text-center hover:scale-105 transition">
            ...
            <p className="text-gray-600">
              Mobile-friendly, user-friendly, and modern layouts.
            </p>
          </div>
          <div className="bg-white rounded-2xl shadow-lg p-6 flex flex-col items-center text-center hover:scale-105 transition">
            ...
            <p className="text-gray-600">
              Built with security, performance, and future growth in mind.
            </p>
          </div>
          <div className="bg-white rounded-2xl shadow-lg p-6 flex flex-col items-center text-center hover:scale-105 transition">
      ...
      <section className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            {
              name: "Basic",
              features: "Static Website, Up to 5 Pages, Responsive Design",
              price: "NPR 10,000",
            },
            {
              name: "Advanced",
              features: "Dynamic Website, CMS Integration, Up to 15 Pages",
              price: "NPR 25,000",
            },
            {
              name: "E-commerce / Custom",
              features: "Online Store, Payment Integration, Unlimited Pages",
              price: "Custom Quote",
            },
          ].map((plan, idx) => (
            <div
          ...
          {[
            {
              ...
              a: "Timeline depends on complexity: Basic 1-2 weeks, Advanced 3-6 weeks, E-commerce 4-8 weeks.",
            },
            {
              q: "Do you provide domain and hosting?",
              a: "Yes, we can provide complete solutions including hosting and domain registration.",
            },
            {
            ...
            },
            {
              ...
              a: "Absolutely, all our websites are responsive and optimized for mobile devices.",
            },
          ].map((faq, idx) => (
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 flex flex-col md:flex-row items-center justify-between bg-cyan-50 rounded-2xl">
        ...
        <div className="flex flex-wrap gap-4">
          <button
            onClick={() => window.open(googleFormLink, "_blank")}
            className="bg-cyan-500 hover:bg-cyan-600 text-white py-2 px-6 rounded-full transition"
          >
            Inquiry Now
          </button>
          <a
